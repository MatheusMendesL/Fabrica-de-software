...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    if ($query_filtro->affected_rows == 0) {
        $results = false;
    };
                ...
                <div class="card card_filtros">
                    <div class="card-body">
                        ...
                        <div class="row d-flex mb-3">
                            <input type="number" name="min" id="1" placeholder="De" class="form-control w-50">
                            <input type="number" name="max" id="2" placeholder="Até" class="form-control w-50">
                        </div>
